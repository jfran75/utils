...
globalkeys = gears.table.join(
    ...
    -- Edge
    awful.key({ modkey },            "e",     function () awful.util.spawn("microsoft-edge") end,
    {description = "open edge", group = "launcher"}),
...
-- Wallpaper
--local wallpaper_cmd="feh --bg-fill /home/jchinchillas/proyectos/raplab/ansible-dev-environment/wallpapers/batman1.jpg"
